(function () {
  ...
  window.browzine = {
    ...
    apiKey: "0d9d0987-0cd6-4df4-85f5-c78933156554",
  ...
  app.controller("prmServiceDetailsAfter", [
    "$scope",
    "$compile",
    function ($scope, $compile) {
      ...
      self.waitForPNX = function () {
        ...
        console.log(this);
        var unbindWatcher = self.$scope.$watch(
          function () {
  ...
  document
    .querySelectorAll("link[rel='icon']")[0]
    .setAttribute("href", "/discovery/custom/49ECB_INST-ECB/img/favicon.png");
  ...
  app.component("prmLinkedUserSelectorAfter", {
    ...
    templateUrl:
      "/discovery/custom/49ECB_INST-ECB/html/prmLinkedUserSelectorAfter.html",
  });

  app.controller("prmLinkedUserSelectorAfter", [
    "$element",
    "$scope",
    "$location",
    "$templateCache",
  ...
  app.controller("prmUserAreaAfterController", [
    "$element",
    "$scope",
    "$location",
    "$templateCache",
  ...
  app.controller("prmVirtualBrowseItemAfter", [
    "$element",
    function ($element) {
