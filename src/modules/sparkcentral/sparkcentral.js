angular.module('sparkcentral', ['angularLoad']).run(['$translate','$rootScope',  function($translate,$rootScope){
  console.log('sparkcentral chat loaded');

  var loaderUrl = 'https://cdn.sparkcentral.com/rtm/web/1.17.0/loader.json'
